...
public:
	 ...
	 *
	 * @param alertData    alert data to replace.
	 *
	 */
	...
	/**
	 * @brief Snooze alert by index.
	 *
	 * @param nth    index of alert to snooze.
	 *
	 */
	void snooze(int nth);
	...
	/**
	 * @brief Dissmiss alert by index.
	 *
	 * @param nth    index of alert to dismiss.
	 *
	 */
	 ...
	 *
	 * @param nths    list of alert indices to dissmiss.
	 *
	 */
	 ...
	 *
	 * @param nth    index of alert to remove.
	 *
	 */
	void remove(int nth);
