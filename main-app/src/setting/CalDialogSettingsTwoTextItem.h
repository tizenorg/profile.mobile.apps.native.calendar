...
public:
	...
	enum sub_item_type
	{
		SUB_FIRST_DAY_OF_WEEK = 0,//!< SUB_FIRST_DAY_OF_WEEK
		SUB_TIME_ZONE,            //!< SUB_TIME_ZONE
		SUB_ALERT_TYPE,           //!< SUB_ALERT_TYPE
		SUB_REMINDER_TYPE,        //!< SUB_REMINDER_TYPE
		SUB_NOTIFICATION_SOUND,   //!< SUB_NOTIFICATION_SOUND
	};
