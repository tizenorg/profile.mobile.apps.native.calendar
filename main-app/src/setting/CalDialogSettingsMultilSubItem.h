...
#ifndef _CAL_DIALOG_SETTINGS_MULTIL_SUB_ITEM_H_
#define _CAL_DIALOG_SETTINGS_MULTIL_SUB_ITEM_H_
...
public:
	/**
	 * @brief Create CalDialogSettingsMultilSubItem
	 *
...
#endif /* _CAL_DIALOG_SETTINGS_MULTIL_SUB_ITEM_H_ */
