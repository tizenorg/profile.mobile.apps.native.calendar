...
/**
 * Set call-back for selection.
 *
 * @param	selectCb	Selection call-back.
 */
...
/**
 * Get back button visibility state.
 *
 * @return	A back button visibility state.
 */
