...
#ifndef _CAL_CUSTOM_LIST_MODEL_H_
#define _CAL_CUSTOM_LIST_MODEL_H_
...
public:
	 ...
	 *
	 * @param[out] dayChanged     true if next event starts in another day.
	 *
...
#endif /* _CAL_CUSTOM_LIST_MODEL_H_ */
