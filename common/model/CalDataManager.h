...
*
* @brief    This class manage changes of %CalSchedule and translate
...
public:
	...
	/**
	 * @brief OperationMode indicate which events will be changed/deleted.
	 */
	enum OperationMode
	{
		ONLY_THIS = 0,
	 ...
	 * @param[in]  inputSchedule  source event
	 * @param[in]  workingCopy    destination event
	 * @param[out] newId          ID of newly inserted event
	 *
	 * @return operation result.
	 *
